...
const CustomHeader: React.FC = () => {
    ...
    const userDropDownComponent = (auth?.user?.email !== undefined) ?
        (
            <div className="relative inline-block">
                ...
                >
                    <span className="mx-1">{auth.user.firstName + ' ' + auth.user.lastName}</span>
                ...
                {isOpen && (
                    <div
                        ...
                        <Link to="/logout" className="flex items-center p-3 text-sm text-gray-600 capitalize transition-colors duration-300 transform dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white">
                            <svg className="w-5 h-5 mx-1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fill="currentColor"
                    ...
                    <div className="mt-6 flow-root">
                        <div className="-my-6 divide-y divide-gray-500/10">
                            <div className="space-y-2 py-6">
                                ...
                                <Link to="/startup/evaluate" className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">
                                    Product
                                </Link>
